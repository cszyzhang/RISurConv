...
def parse_args():
    '''PARAMETERS'''
    parser = argparse.ArgumentParser('RISurConv')
...
def main(args):
    ...
    '''MODEL LOADING'''
    MODEL = importlib.import_module('risurconv_part_seg')
    ...
    log_string('Inctance avg IOU is: %.5f' % test_metrics['inctance_avg_iou'])
